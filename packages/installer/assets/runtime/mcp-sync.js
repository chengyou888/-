...
exports.MCP_MANAGED_START = "# BEGIN codex汉化增强plus版 MANAGED MCP SERVERS";
exports.MCP_MANAGED_END = "# END codex汉化增强plus版 MANAGED MCP SERVERS";
...
function mergeManagedMcpBlock(currentToml, managedBlock) {
    if (!managedBlock && !hasManagedMcpBlock(currentToml))
        return currentToml;
...
function hasManagedMcpBlock(toml) {
