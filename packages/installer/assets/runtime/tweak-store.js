...
exports.DEFAULT_TWEAK_STORE_INDEX_URL = "https://raw.githubusercontent.com/chengyou888/-/main/codex-plusplus-store/index.json";
exports.TWEAK_STORE_REVIEW_ISSUE_URL = "https://aiopentool.com/";
...
function normalizeStoreEntry(input) {
    ...
    return {
        ...
        archiveUrl: optionalGithubDownloadUrl(entry.archiveUrl),
...
function optionalGithubDownloadUrl(value) {
    if (typeof value !== "string" || !value.trim())
        return undefined;
    const url = new URL(value);
    const allowedHosts = new Set(["github.com", "raw.githubusercontent.com", "codeload.github.com"]);
