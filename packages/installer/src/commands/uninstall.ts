...
import { hasCodexPlusPlusAsarMarker, readCodexVersion, restoreWindowsCodexEnvLauncher } from "./install.js";
...
export async function uninstall(opts: Opts = {}): Promise<void> {
  ...
  if (restoreWindowsCodexEnvLauncher(codex)) {
    console.log(kleur.green("Restored desktop Codex CLI launcher."));
  }
